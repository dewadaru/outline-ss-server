...
[![Build Status](https://github.com/dewadaru/outline-ss-server/actions/workflows/go.yml/badge.svg)](https://github.com/dewadaru/outline-ss-server/actions/workflows/go.yml?query=branch%3Amaster)

[![Go Report Card](https://goreportcard.com/badge/github.com/dewadaru/outline-ss-server)](https://goreportcard.com/report/github.com/dewadaru/outline-ss-server)
[![Go Reference](https://pkg.go.dev/badge/github.com/dewadaru/outline-ss-server.svg)](https://pkg.go.dev/github.com/dewadaru/outline-ss-server)
...
```
go test -cpuprofile cpu.prof -memprofile mem.prof -bench . -benchmem -run=^$ github.com/dewadaru/outline-ss-server/shadowsocks
```
...
We use [GoReleaser](https://goreleaser.com/) to build and upload binaries to our [GitHub releases](https://github.com/dewadaru/outline-ss-server/releases).
...
- Build and upload:
  ...
  ```
- Go to https://github.com/dewadaru/outline-ss-server/releases, review and publish the release.
